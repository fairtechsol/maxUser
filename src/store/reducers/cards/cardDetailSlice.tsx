...
import { getDragonTigerDetailHorseRacing, update7CardMatchRates, updateCardAbjRates, updateCardMatchRates, updateTeenPattiMatchRates } from "../../actions/cards/cardDetail";
