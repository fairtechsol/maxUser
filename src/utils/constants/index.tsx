    ...
    rules: [
      {
        ...
        description: [
          ...
          {
            text:
              "If the selection is in a multiple bet or accumulator, any refund must be requested before the kick-off of the first leg of the multiple bet.",
            color: "red",
          },
          {
            text:
              "Games which have their kick-off altered well in advance to accommodate live TV or ease fixture congestion will not be classed as postponed.",
            color: null,
          },
          {
            text:
      ...
      },
      {
        ...
        description: [
          {
            text:
              "Match Odds: All bets apply to the full 'regular time' period including stoppage time. Extra-time and/or penalty shoot-out is not included. Bets matched between the time of a VAR review and its outcome will be voided.",
            color: null,
          },
          {
            text:
              "Under/Over Goals: In the event of a match starting but not being completed, all bets will be void unless the specific market outcome is already determined.",
            color: null,
          },
          {
            text:
          ...
          {
            text:
              "Draw No Bet: Predict which team will be the winner. In case of a draw, all bets will be void. If a game is abandoned, bets will be void.",
            color: null,
          },
          {
            text:
              "Both Teams to Score: Predict whether both teams will score at least one goal in the game. Own goals count towards the credited team. If a game is abandoned, bets will be void unless already determined.",
            color: null,
          },
          {
            text:
              "Total Corners: Predict which team will take the named corner in the game. If this specific corner is not taken, bets will be void.",
            color: null,
          },
          {
            text:
              "Goals Odd/Even: Any match resulting in 0-0 will be settled as an even number of goals. For Team Odd/Even markets, if the specified team does not score, it is settled as even.",
            color: null,
          },
          {
            text:
              "1X2 Corners: Predict which team will get more corners. Awarded but untaken corners do not count. Re-taken corners count as one.",
            color: null,
          },
          {
            text:
              "Under/Over Card in Match: Predict the number of cards in a match. Cards shown after the full-time whistle do not count.",
            color: null,
          },
          {
            text:
          ...
          {
            text:
              "First Half Under/Over Goals: All bets apply to Full Time according to match officials. Extra-time and penalty shootouts are excluded.",
            color: null,
          },
          {
            text:
              "Penalty Taken?: Predict if a penalty will be awarded and taken during the match. Extra-time and penalty shootouts are excluded.",
            color: null,
          },
          {
            text:
              "Correct Score: Predict the final score of the match. Extra-time and penalty shootouts are excluded.",
            color: null,
          },
          {
            text:
              "Corners Number/Odds: Predict how many corners will be taken in the match. Only corners that are taken count.",
            color: null,
          },
          {
            text:
              "Team_A/B +1/2/3: Predict who will win the match with the stated handicap applied. Extra-time and penalty shootouts are excluded.",
            color: null,
          },
          {
            text:
              "Live Streaming & Animation: Data may be subject to time delay and/or inaccuracies. Users relying on this data do so at their own risk.",
            color: null,
          },
          {
            text:
              "Company reserves the right to suspend/void any bets deemed illegitimate. Only winning bets will be voided in such cases.",
            color: "red",
          },
        ],
      },
    ...
    rules: [
      ...
      },
      {
        ...
        description: [
          {
            text:
              "Our non-runner rule relates to the adjustment of odds on bets already matched when a horse in a race is declared a non-runner.",
            color: null,
          },
          {
            text:
          ...
          {
            text:
              "Once a non-runner is declared each selection in the market will be given an appropriate reduction factor.",
            color: null,
          },
        ],
      },
      {
        ...
        description: [
          ...
          {
            text:
              "Reserves: A reserve runner may appear in the relevant markets but will have a non-applicable reduction factor until we receive confirmation that it is a confirmed runner.",
            color: null,
          },
        ],
      },
      {
        ...
        description: [
          ...
          {
            text:
              "If a runner is not included in a market because of an error, we reserve the right to introduce the missing runner into the market at any time prior to settlement.",
            color: null,
          },
          {
            text:
              "Company reserves the right to suspend/void any illegitimate bets (e.g., due to VPN/robot use). Only winning bets will be voided.",
            color: "red",
          },
        ],
      },
      {
        ...
        description: [
          {
            text:
              "Data may be subject to time delay and/or inaccuracies. Users relying on this data do so at their own risk.",
            color: null,
          },
        ],
      },
    ...
    rules: [
      {
        ...
        description: [
          ...
          {
            text:
              "Company reserves the right to suspend/void any id/bets if the same is found to be illegitimate. For example in case of VPN/robot-use/multiple entry from same or different IP and others. Note: only winning bets will be voided.",
            color: "red",
          },
          {
            text:
    ...
    rules: [
      {
        ...
        description: [
          ...
          {
            text:
              "Set Winner:- In the event of the set not being completed bets will be void. Exceptions are made for bets on sets which are already over, in this case the bets will be settled.",
            color: "black",
          },
          {
            text:
    ...
    rules: [
      {
        ...
        description: [
          ...
          {
            text:
              "Match Odds:- Predict which player will win the match. In the event of any of the named players in a match changing before the match starts then all bets are void. In the event of a match starting but not being completed, then all bets will be void.",
            color: "black",
          },
          {
            text:
    ...
    rules: [
      {
        ...
        description: [
          ...
          {
            text:
              "2. We will simply compare both teams 25 overs score higher score team will be declared winner in ODI (If both teams same score means, low wickets team will be declared winner. In case, both teams same score & same wickets means highest boundaries team will be declared winner.If all same then will be declared No result)",
            color: "red",
          },
          {
            text:
              "3. We will simply compare both teams 10 overs higher score team will be declared winner in T20 matches (If both teams same score means, low wickets team will be declared winner. In case, both teams same score & same wickets means highest boundaries team will be declared winner.If all same then will be declared No result)",
            color: "red",
          },
          {
            text:
              "4. Any query about the result or rates should be contacted within 7 days of the specific event, the same will not be considered valid post 7 days from the event.",
            color: "red",
          },
          {
            text:
              "5. Company reserves the right to suspend/void any id/bets if the same is found to be illegitimate. For example incase of vpn/robot-use/multiple entry from same IP/ multiple bets at the same time (Punching) and others. Note : only winning bets will be voided.",
            color: "red",
          },
          {
            text:
          ...
          {
            text:
              "7. If two team ends up with equal points, then result will be given based on the official point table",
            color: "red",
          },
        ],
      },
      {
        ...
        description: [
          ...
          {
            text:
              "2. All advance fancy will be suspended before toss or weather condition. All advance fancy will be voided if over reduced before match start.",
            color: "red",
          },
          {
            text:
          ...
          {
            text:
              "10. Company reserves the right to suspend/void any id/bets if the same is found to be illegitimate. For example incase of VPN/robot-use/multiple entry from same IP and others. Note : only winning bets will be voided.",
            color: "red",
          },
          {
            text:
          ...
          {
            text:
              "20 over run will not be considered as valid if 20 overs is not completed due to any situation.",
            color: "black",
          },
          {
          ...
          {
            text:
              "Four, sixes, wide, wicket, extra run, total run, highest over and top batsman, maiden over, caught-out, no-ball, run-out, fifty and century are valid only if match has been completed. In case due to rain over has been reduced all other fancy will be deleted.",
            color: "black",
          },
          {
            text:
              "1st 6 over dot ball and 20 over dot ball fancy are valid only in the 1st innings.",
            color: "black",
          },
          {
          ...
          {
            text:
              "All bets will be considered as valid if a player has been replaced under concussion substitute, result will be given for the runs scored by the mentioned player. For example DM Bravo gets retired hurt at 23 runs, then result will be given for 23.",
            color: "black",
          },
          {
            text:
              "Bets of both the player will be valid under concussion substitute.",
            color: "black",
          },
          {
          ...
          {
            text:
              "16.In case, company will find Ground bets, Group betting, Punching bets, Multiple entries with same IP or any fraud or unusual activities are detected then Company will be void winning bets and charge penalty of 2X (Two times) from winning amount.",
            color: "red",
          },
          {
            text: "Special Events:",
          ...
          {
            text:
              "Power Play for the 1st 3 overs. Only 1 player allowed beyond the Inner box marking. After the end of power play over, only 2 players can be outside the Inner Box.",
            color: "black",
          },
          {
          ...
          {
            text:
              "If the ball touches the upper net and if any player catches the ball, the batsman is considered out.",
            color: "black",
          },
          {
            text:
              "If the Ball Touches the Upper Net and lands safely on the field, then the batsman have to take a physical run if they want, if no physical run is taken there will be no runs.",
            color: "black",
          },
          {
          ...
          {
            text:
              "If the player hits the net after the middle line (Zone C) its 2 bonus runs. (only taken into consideration if the players take a physical run)",
            color: "black",
          },
          {
            text:
              "If the player hits the net before the middle line (Zone B) its 1 bonus run. (only taken into consideration if the players take a physical run",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "If the ball hits the upper net and bounces and goes straight to the boundary (Zone D) it’s a 4.",
            color: "black",
          },
          {
            text:
              "Note: Bonus Runs are only applied if the ball hits or touches the Side Nets of that particular zone (B&C) and taken into consideration if the players take a physical Run.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "If a bowler bowls a no or a wide ball, the delivery will not be counted and each wide or no ball will be given 2 runs to the batting team total. ",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "Dismissals in Indoor Cricket are as followed: Bowled, Run Out, Catch Out, Stumping and Handling the Ball.",
            color: "black",
          },
          {
            text:
              "If the bowler is bowling directly above waist and one bounce above shoulder level it is counted as a no ball, but the batter has to play the ball from the crease, in case the batter is outside the crease and plays the ball it will be termed as a good ball.",
            color: "black",
          },
          {
            text:
              "Incomplete action or throwing the ball to the stump will be termed as a no ball and 2 runs will be given to the batting team.",
            color: "black",
          },
          {
            text:
              "If the batsman does not hit the ball after it is bowled it is considered as a Dot Ball, the batsman gets 0 runs.",
            color: "black",
          },
          {
            text:
              "If the batsman hits the ball and the fielders or the wicket-keeper catch it without it touching the floor, the batsman will be dismissed as Catch Out.",
            color: "black",
          },
          {
            text:
              "If the ball touches a fielder and then hits the nets (zones), the bonus runs will be counted, if the physical runs are taken by the batter.",
            color: "black",
          },
          {
          ...
          {
            text:
              "If the ball is caught directly after touching the zones (B/C), it will be treated as NOT OUT and bonus runs are applicable if physical run is taken.",
            color: "black",
          },
          {
            text:
              "If the ball touches the bonus run zones and the fielder accomplishes a run out, the batter will be OUT and no bonus runs will be counted. Physical run will be counted if 1 run is taken and run out happens during the second run",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "When 6 wickets of a team fall, the last batter will be allowed to bat. The team will send a runner at non-striker’s end. After every physical run taken, the last batsman will have to go back to strike to face the next ball. Run out for the runner will mean dismissal for the last batsman.",
            color: "black",
          },
          {
          ...
          {
            text:
              "Settlement occurs once the stipulated conditions are met, which involves either completion of the allotted overs or the batting team's dismissal, including weather disturbances.",
            color: "black",
          },
          {
            text:
              "In the event of a weather-shortened match, all Bhav Bets placed in the Inning Run Bhav market will be settled according to the official result. For limited overs matches, this includes results determined by the Duckworth Lewis method.",
            color: "black",
          },
          {
            text:
              "In case of pitch vandalism, player safety concerns, stadium damage, acts of terrorism, or acts of God, the company holds the authority to nullify all bets, with the exception of those related to markets that have already been conclusively settled.",
            color: "black",
          },
          {
            text:
              "Bets made during instances of incorrect scorecard updates, inaccurate commentary, delays in suspending the Bhav Bets of Total Innings Runs market, or erroneous updates of rates and odds for Bhav Bets in Total Innings Runs will be removed and deleted from user accounts.",
            color: "black",
          },
          {
            text:
              "Example: 1st inning run Bhav (ENG v AUS), 2nd Inning run Bhav (ENG v AUS) - England vs Australia T20 Match",
            color: "black",
          },
          {
            text:
              "Total Match 30s: How many batsman's scored 30 to 49 runs in the full match. If a Player reached 50 means, Not considered in this Event.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "High Partnership Boundaries in the Match: Maximum Number of Boundaries Scored during any Partnership.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "Total Match 1st over runs: Average 4 runs will be given in case match abandoned or over reduced (Only First Innings is Valid).",
            color: "black",
          },
          {
            text:
              "Total Match 1st over Dot Ball: Average 4 runs will be given in case match abandoned or over reduced (Only First Innings is Valid).",
            color: "black",
          },
          {
            text:
              "Total Match 1st 10 over run: Average 50 runs will be given in case match abandoned or over reduced (Only First Innings is Valid).",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "Total Ducks: Average 1 Duck out will be given in case match abandoned or over reduced.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "Total 50+ Partnerships: Average 3 Fifty plus Partnerships will be given in case match abandoned or over reduced. 50 and 50 Above Partnerships All Counted in this.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "Most Balls Faced By a Batsman in the Match: Maximum Balls Faced by an Individual Batsman in any Single Match.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "Most Dot balls By a Bowler in an Inning: Maximum Dot balls Bowled by a Bowler in his Quota of Innings.",
            color: "black",
          },
          {
            text:
              "Most runs given by Bowler in an Inning: Maximum Runs conceded by an individual Bowler in an Innings.",
            color: "black",
          },
          {
            text:
              "Most wickets by Bowler in an inning: Maximum Wickets taken by an individual Bowler in an Innings.",
            color: "black",
          },
          {
            text:
              "Total 50 Plus Partnership runs: 50 and above 50 runs partnership will be counted in this event.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "Women's Premier League (WPL): If WPL fixture of 22 matches gets reduced due to any reason, then all the special fancies will be voided (Match abandoned due to rain/bad light will not be considered in this).",
            color: "black",
          },
          {
            text:
              "Total matches 1st over runs: Average 5 runs will be given in case match abandoned or over reduced (only 1st innings valid).",
            color: "black",
          },
          {
            text:
              "Total matches 1st 6 over runs: Average 40 runs will be given in case match abandoned or over reduced (Only 1st Innings valid).",
            color: "black",
          },
          {
            text:
              "Total 4's: Average 32 fours will be given in case match abandoned or over reduced.",
            color: "black",
          },
          {
            text:
              "Total 30's: Average 2 sixes will be given in case match abandoned or over reduced.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "Highest Match 1st over runs in the match: Only first innings is valid.",
            color: "black",
          },
          {
          ...
          {
            text:
              "Most Balls Faced By a Batsman: Maximum Balls Faced by a batsman in one Innings.",
            color: "black",
          },
          {
            text:
              "Most 4's by an individual batsman in an Inning: Maximum Number of Fours Hit By A Batsman in one Innings.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "In fastest fifty always the first 50 runs will be considered, for example, if S Mandhana scores 1st fifty in 17 balls and scores 100 in next 14 balls, fastest 50 will be given based on the balls for the 1st fifty runs.",
            color: "black",
          },
          {
            text: "Super over will not be included.",
          ...
          {
            text:
              "Total Overs: This market is based on how many overs will be played in the match across both team's innings combined. (If an Inning completed in 83.4 overs then that calculated as 84 overs).",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "Total Impact overs: Number of overs scored 10 runs or above. Team wise only 1st inning are valid and Match wise both innings are valid.",
            color: "black",
          },
          {
            text:
      ...
      },
      {
        ...
        description: [
          ...
          {
            text:
              "For one day 50 over and for T20 match 20 overs must be played for top batsmen otherwise all bets will be deleted.",
            color: "black",
          },
          {
          ...
          {
            text:
              "3. In case Man of the Match is shared between two players then Dead heat rule will be applicable. For example, K Perera and T Iqbal share the Man of the Match, then the settlement will be done 50% of the rates accordingly.",
            color: "black",
          },
          {
          ...
          {
            text:
              "2. All bets will be deleted if both the teams hit the same number of sixes.",
            color: "black",
          },
          {
          ...
          {
            text:
              "2. All the bets will be deleted if both the teams score is the same (Runs scored in 6 or 10 overs).",
            color: "black",
          },
          {
          ...
          {
            text:
              "All bets will be deleted unless one ball is played by both the mentioned players.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "All bets will be deleted if both the players scored the same runs. For example, H Amla and J Bairstow are the batsmen matched, H Amla and J Bairstow both scored 38 runs then all bets will be deleted.",
            color: "black",
          },
          {
          ...
          {
            text:
              "1. Bets for Favourite opening pair from the two mentioned opening pairs.",
            color: "black",
          },
          {
            text:
              "2. Runs made by both the opening players will be added. For example, J Roy scored 20 runs and J Bairstow scored 30 runs; the result will be 50 runs.",
            color: "black",
          },
          {
            text:
              "3. The highest run made by the pair will be declared as winner. For example, Opening pair ENG total is 70 runs and Opening pair SA is 90 runs, then SA 90 runs will be declared as winner.",
            color: "black",
          },
          {
            text: "Both innings will be valid.",
          ...
          {
            text:
              "The boundary hit through the off side of the stump will be considered as off side four.",
            color: "black",
          },
          {
            text:
              "The boundary hit through the leg side of the stump will be considered as leg side four.",
            color: "black",
          },
          {
            text:
    ...
    rules: [
      {
        ...
        description: [
          ...
          {
            text:
              "The final result declared by the Election Commission of India for assembly elections of various states of India for a particular year will be valid in our exchange. The customers are entirely responsible for their bets at all times.",
            color: "black",
          },
          {
            text:
              "All bets will be voided if the election doesn't take place in the given time by the Election Commission or as per our exchange management decision.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "Accidental issues during assembly elections will not be counted in our exchange. If required, additional candidates may be added on request.",
            color: "black",
          },
          {
            text:
              "Kindly be informed no candidates will be partially settled and will remain in the market until it is fully settled. This is to ensure that all customers can continue trading for the candidates that they have positions on, since each candidate is still a valid runner in this market.",
            color: "black",
          },
          {
            text:
              "Please be informed that the transmissions described as 'live' by few broadcasters may actually be delayed due to multiple scenarios.",
            color: "black",
          },
          {
            text:
    ...
    rules: [
      {
        ...
        description: [
          {
            text:
              "Match Odds: Predict which player will win the match. In the event of a match starting but not being completed, the player progressing to the next round or being awarded the victory will be deemed the winner for settlement purposes. In the event of a match not starting at all, all bets are refunded.",
            color: "black",
          },
          {
            text:
              "Frame Winner: If the nominated frame is not played, bets will be void. Similarly, if the nominated frame is awarded to a player without a shot being played, then all bets will be void.",
            color: "black",
          },
          {
            text:
    ...
    rules: [
      {
        ...
        description: [
          ...
          {
            text:
              "Result of individual player of fancy will be validated only when player plays that match.",
            color: "black",
          },
          {
            text:
              "In any case wrong rate has been given in fancy, that particular bet will be deleted.",
            color: "black",
          },
          {
            text:
          ...
          {
            text:
              "In case, the company detects Ground bets, Group betting, Punching bets, Multiple entries with the same IP or any fraud or unusual activities, the company will void winning bets and charge a penalty of 2X (Two times) from the winning amount.",
            color: "red",
          },
          {
            text:
              "If any player gets injured during the match, then all the bets will be valid for that individual player.",
            color: "black",
          },
        ],
      },
      {
        ...
        description: [
          {
            text:
              "Company reserves the right to suspend/void any id/bets if the same is found to be illegitimate. For example, in case of VPN/robot-use/multiple entries from the same or different IP and others. Note: only winning bets will be voided.",
            color: "red",
          },
          {
            text:
    ...
    rules: [
      {
        ...
        description: [
          {
            text:
              "Match Odds: Bets will be void if the match is not completed.",
            color: "red",
          },
          {
            text: "Next Goal: Predict which team will score the X-th goal.",
          ...
          {
            text:
              "1st Half Winner: Half bets will be settled at the end of the 1st half. In the event of a 1st half not being completed, bets will be void.",
            color: "black",
          },
          {
            text:
              "Highest Scoring Half: Predict in which Event Part will be scored most.",
            color: "black",
          },
          {
            text:
