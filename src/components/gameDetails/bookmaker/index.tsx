        ...
        <div className="bookmakerContainer">
            ...
            {data?.activeStatus != "live" && <div className="suspended-overlayRatesBookmaker"><span className={`${!isMobile ? "f-size18":"f-size16"} suspendedTxtBookmaker`}>
              ...
              {(data?.activeStatus === "live" && data?.runners?.[0]?.status !="ACTIVE") && <div className="suspended-overlayRatesBookmaker"><span className={`${!isMobile ? "f-size18":"f-size12"} suspendedTxtBookmaker`}>
                SUSPENDED</span></div>}
              {box ===6 && (<div className="bookmakerBackBox back3Background" onClick={()=> handlePlaceBet(data?.runners?.[0]?.ex?.availableToBack?.[0]?.price,"BACK",detail?.teamA,data?.runners?.[0]?.status,data?.runners?.[0]?.ex?.availableToBack?.[0]?.tno)}>
                ...
                {box ===6 && ( <div className="bookmakerBackBox back2Background" onClick={()=> handlePlaceBet(data?.runners?.[0]?.ex?.availableToBack?.[1]?.price,"BACK",detail?.teamA,data?.runners?.[0]?.status,data?.runners?.[0]?.ex?.availableToBack?.[1]?.tno)}>
                ...
                <div className="bookmakerBackBox back1Background" onClick={()=> handlePlaceBet(box ===6 ?data?.runners?.[0]?.ex?.availableToBack?.[2]?.price : data?.runners?.[0]?.ex?.availableToBack?.[0]?.price,"BACK",detail?.teamA,data?.runners?.[0]?.status,box ===6 ?data?.runners?.[0]?.ex?.availableToBack?.[2]?.tno : data?.runners?.[0]?.ex?.availableToBack?.[0]?.tno)}>
                ...
                <div className="bookmakerBackBox lay1Background" onClick={()=> handlePlaceBet(data?.runners?.[0]?.ex?.availableToLay?.[0]?.price,"LAY",detail?.teamA,data?.runners?.[0]?.status,data?.runners?.[0]?.ex?.availableToLay?.[0]?.tno)}>
                ...
                {box ===6 && (<div className="bookmakerBackBox lay2Background" onClick={()=> handlePlaceBet(data?.runners?.[0]?.ex?.availableToLay?.[1]?.price,"LAY",detail?.teamA,data?.runners?.[0]?.status,data?.runners?.[0]?.ex?.availableToLay?.[1]?.tno)}>
                ...
                {box ===6 && (<div className="bookmakerBackBox lay3Background" onClick={()=> handlePlaceBet(data?.runners?.[0]?.ex?.availableToLay?.[2]?.price,"LAY",detail?.teamA,data?.runners?.[0]?.status,data?.runners?.[0]?.ex?.availableToLay?.[2]?.tno)}>
            ...
            {data?.activeStatus != "live" && <div className="suspended-overlayRatesBookmaker"><span className={`${!isMobile ? "f-size18":"f-size16"} suspendedTxtBookmaker`}>
              ...
              {(data?.activeStatus === "live" && data?.runners?.[1]?.status !="ACTIVE") && <div className="suspended-overlayRatesBookmaker"><span className={`${!isMobile ? "f-size18":"f-size12"} suspendedTxtBookmaker`}>
                SUSPENDED</span></div>}
              {box ===6 && (<div className="bookmakerBackBox back3Background" onClick={()=> handlePlaceBet(data?.runners?.[1]?.ex?.availableToBack?.[0]?.price,"BACK",detail?.teamB,data?.runners?.[1]?.status,data?.runners?.[1]?.ex?.availableToBack?.[0]?.tno)}>
                ...
                {box ===6 && ( <div className="bookmakerBackBox back2Background" onClick={()=> handlePlaceBet(data?.runners?.[1]?.ex?.availableToBack?.[1]?.price,"BACK",detail?.teamB,data?.runners?.[1]?.status,data?.runners?.[1]?.ex?.availableToBack?.[1]?.tno)}>
                ...
                <div className="bookmakerBackBox back1Background" onClick={()=> handlePlaceBet(box ===6 ?data?.runners?.[1]?.ex?.availableToBack?.[2]?.price : data?.runners?.[1]?.ex?.availableToBack?.[0]?.price,"BACK",detail?.teamB,data?.runners?.[1]?.status,box ===6 ?data?.runners?.[1]?.ex?.availableToBack?.[2]?.tno : data?.runners?.[1]?.ex?.availableToBack?.[0]?.tno)}>
                ...
                <div className="bookmakerBackBox lay1Background" onClick={()=> handlePlaceBet(data?.runners?.[1]?.ex?.availableToLay?.[0]?.price,"LAY",detail?.teamB,data?.runners?.[1]?.status,data?.runners?.[1]?.ex?.availableToLay?.[0]?.tno)}>
                ...
                {box ===6 && (<div className="bookmakerBackBox lay2Background" onClick={()=> handlePlaceBet(data?.runners?.[1]?.ex?.availableToLay?.[1]?.price,"LAY",detail?.teamB,data?.runners?.[1]?.status,data?.runners?.[1]?.ex?.availableToLay?.[1]?.tno)}>
                ...
                {box ===6 && (<div className="bookmakerBackBox lay3Background" onClick={()=> handlePlaceBet(data?.runners?.[1]?.ex?.availableToLay?.[2]?.price,"LAY",detail?.teamB,data?.runners?.[1]?.status,data?.runners?.[1]?.ex?.availableToLay?.[2]?.tno)}>
            ...
            {data?.activeStatus != "live" && <div className="suspended-overlayRatesBookmaker"><span className={`${!isMobile ? "f-size18":"f-size16"} suspendedTxtBookmaker`}>
              ...
              {(data?.activeStatus === "live" && data?.runners?.[2]?.status !="ACTIVE") && <div className="suspended-overlayRatesBookmaker"><span className={`${!isMobile ? "f-size18":"f-size12"} suspendedTxtBookmaker`}>
                SUSPENDED</span></div>}
              {box ===6 && (<div className="bookmakerBackBox back3Background" onClick={()=> handlePlaceBet(data?.runners?.[2]?.ex?.availableToBack?.[0]?.price,"BACK",detail?.teamC,data?.runners?.[2]?.status,data?.runners?.[2]?.ex?.availableToBack?.[0]?.tno)}>
                    <span className={`${!isMobile ? "f-size18":"f-size12"} bookmakerRate1Box`}>{data?.runners?.[0]?.ex?.availableToBack?.[0]?.price ?? '-'}</span>
                    <span className={`${!isMobile ? "f-size12":"f-size10"} bookmakerRate2Box`}>{data?.runners?.[0]?.ex?.availableToBack?.[0]?.size}</span>
                </div>)}
                {box ===6 && ( <div className="bookmakerBackBox back2Background" onClick={()=> handlePlaceBet(data?.runners?.[2]?.ex?.availableToBack?.[1]?.price,"BACK",detail?.teamC,data?.runners?.[2]?.status,data?.runners?.[2]?.ex?.availableToBack?.[1]?.tno)}>
                ...
                <div className="bookmakerBackBox back1Background" onClick={()=> handlePlaceBet(box ===6 ?data?.runners?.[2]?.ex?.availableToBack?.[2]?.price : data?.runners?.[2]?.ex?.availableToBack?.[0]?.price,"BACK",detail?.teamC,data?.runners?.[2]?.status,box ===6 ?data?.runners?.[2]?.ex?.availableToBack?.[2]?.tno : data?.runners?.[2]?.ex?.availableToBack?.[0]?.tno)}>
                ...
                <div className="bookmakerBackBox lay1Background" onClick={()=> handlePlaceBet(data?.runners?.[2]?.ex?.availableToLay?.[0]?.price,"LAY",detail?.teamC,data?.runners?.[2]?.status,data?.runners?.[2]?.ex?.availableToLay?.[0]?.tno)}>
                ...
                {box ===6 && (<div className="bookmakerBackBox lay2Background" onClick={()=> handlePlaceBet(data?.runners?.[2]?.ex?.availableToLay?.[1]?.price,"LAY",detail?.teamC,data?.runners?.[2]?.status,data?.runners?.[2]?.ex?.availableToLay?.[1]?.tno)}>
                ...
                {box ===6 && (<div className="bookmakerBackBox lay3Background" onClick={()=> handlePlaceBet(data?.runners?.[2]?.ex?.availableToLay?.[2]?.price,"LAY",detail?.teamC,data?.runners?.[2]?.status,data?.runners?.[2]?.ex?.availableToLay?.[2]?.tno)}>
