    ...
    <div className="modal-body">
      ...
      <div className="rules-section">
        ...
        <ul className="pl-4 pr-4 list-style">
          ...
          <li>
            <b>Note:</b> Wickets or extras with runs will not be considered in the above-mentioned events.
          </li>
        </ul>
      </div>
      ...
      <div className="rules-section">
        ...
        <ul className="pl-4 pr-4 list-style">
          <li>
            Particular Wickets (Caught, Bowled, Run Out, LBW, Stumped, and Others) or Wickets (Any Wickets) only
            wicket will be considered.
          </li>
          <li>
            <b>Note:</b> Any runs with Wickets will not be considered in these events.
          </li>
        </ul>
      </div>
      ...
      <div className="rules-section">
        ...
        <ul className="pl-4 pr-4 list-style">
          ...
          <li>
            <b>Note:</b> Any runs or wicket on extra balls will not be considered in these events.
          </li>
      ...
      <div className="rules-section">
        ...
        <ul className="pl-4 pr-4 list-style">
          <li>
            The videos are from different broadcasters, so in such cases, the scoreboard will update late. We will give
            results only on the basis of our rules and as per the videos displayed.
          </li>
        </ul>
      </div>
    </div>
