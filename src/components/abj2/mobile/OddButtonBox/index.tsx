...
const OddButtonBox = ({ profitLoss,value1,value2,lock,handleBet,data }: any) => {
  return (
    <div className="commonButtonBoxContainerOdd" >
      <div >
        <span style={{fontSize:"20px",fontWeight:"bolder"}}>{value2 === "icon1" ? (
            <>
      ...
      <div className={`evenOddbtn-theme-m ${lock?'suspended':''}`} style={{width:"95%"}} onClick={()=>!lock ? handleBet(data):null}>
