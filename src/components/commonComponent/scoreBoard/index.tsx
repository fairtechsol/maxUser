    ...
    <Container className="scorecard mb-1">
      <Row>
        <Col xs={12} md={6}>
          ...
          <div className={isMobile ? "title-12 team-1 row mb-2" :"team-1 row mb-2 "}>
            <span className="team-name col-3">{data?.spnnation1}</span>
            <span className="score col-4 text-end">{data?.score1}</span>
            {/* {index === 1 && ( */}
            <span className={isMobile ? "title-12 team-name col-5" :"team-name col-5"}>
        ...
        <Col xs={12} md={6}>
          <div className={isMobile ? "title-12 text-xl-end mb-2" : "text-xl-end mb-2"}>
            <span>{data?.spnmessage}</span>
          </div>
          <Row>
            <Col xs={12}>
              <div className="text-xl-end ball-by-ball mt-2" style={{display:"flex",flexDirection:"row",justifyContent: isMobile ? "flex-start" : "flex-end"}}>
