  ...
  return (
    data?.mid != "0" && (
      <Container>
        <Row>
          <Col>
            <h6 style={{ color: max===parseInt(data?.C1) && max!=0?"green":"white" }}>{parseInt(data?.C1)>0?'Player 8:'+data?.C1:""}</h6>
        ...
        <Row>
          <Col>
            <h6 style={{ color:  max===parseInt(data?.C2) && max!=0?"green":"white" }}>{parseInt(data?.C1)>0?'Player 9:'+data?.C2:""}</h6>
            <div style={{ display: "flex", gap: "10px", flexDirection: "row" }}>
        ...
        <Row>
          <Col>
            <h6 style={{ color: max===parseInt(data?.C3) && max!=0?"green":"white" }}>{parseInt(data?.C1)>0?'Player 10:'+data?.C3:""}</h6>
            <div style={{ display: "flex", gap: "10px", flexDirection: "row" }}>
        ...
        <Row>
          <Col>
            <h6 style={{ color: max===parseInt(data?.C4) && max!=0?"green":"white" }}>{parseInt(data?.C1)>0?'Player 11:'+data?.C4:""}</h6>
            <div style={{ display: "flex", gap: "10px", flexDirection: "row" }}>
