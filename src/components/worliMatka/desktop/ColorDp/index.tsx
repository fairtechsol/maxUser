    ...
    <div
      ...
      onClick={() => {
        ...
        return value == "0"
          ? ""
          : value == "COLOR DP ALL"
          ? handleBet("Color Dp - 11")
          : handleBet("Color Dp - " + value);
      }}
    >
  ...
  return (
    ...
    >
      ...
      <div className="worli-right">
        <div className="worli-box-row">{renderBox("COLOR DP ALL", 10)}</div>
      </div>
