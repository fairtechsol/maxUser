...
const [otp, setOtp] = useState()
    ...
    return(
        ...
        <div className="p-4 d-flex flex-column" style={{backgroundColor:"#fff"}}>
          <span className="text-center" style={{fontSize:"22px",color:"#004a25"}}>
            Security Code Verification
          </span>
          <span className="title-16 text-center">Enter the 6-digit code from your security auth verification app</span>
